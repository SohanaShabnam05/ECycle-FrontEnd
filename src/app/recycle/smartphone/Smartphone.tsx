...
const Smartphone: React.FC = () => {
  ...
  useEffect(() => {
    fetch("https://procoders-myntra-hackathon-backend.onrender.com/api/v1/facility")
 ...
 const handleSubmit = async () => {
  ...
  if (isAuthenticated() && facilityData.length > 0) {
    if (
      ...
      try {
        const response = await fetch("https://procoders-myntra-hackathon-backend.onrender.com/api/v1/booking", {
          method: "POST",
          headers: {
    ...
    <div className="container mx-auto p-8">
      ...
      >
        ...
        <div className="mb-4 md:col-span-2">
          <button
            type="submit"
            className="bg-cyan-700 text-xl text-white px-6 py-3 rounded-md w-full"
          >
            Submit
          </button>
        </div>
