...
import logo from "../../assets/ELocate-s3.png"
  ...
  return (
    <header className={`header ${isHeaderActive ? "active" : ""}`} data-header>
      <div className="container shadow-md">
        ...
        <h1 className='font-montserrat font-bold text-xl ml-12 md:ml-4 md:text-2xl text-cyan-600 flex items-center gap-[1vh]'>
          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div className="absolute top-12 right-0 projects p-4  shadow-md divide-y rounded-lg w-44 mt-2">
                <Link href="/profile" className="hover:text-cyan-500">
                  Profile
                </Link>
                <button
