  ...
  const register = async () => {
    ...
    try {
      const response = await axios.post(
        "https://procoders-myntra-hackathon-backend.onrender.com/api/v1/auth/register",
        formData
      );
  ...
  return (
    <>
      <div className="my-3 text-center">
        <span className=" text-4xl font-bold">Welcome to ECycle</span>
      ...
      <div className="mx-auto w-4/5 md:w-256 h-[90vh] md:h-[70vh]">
        ...
        <button
          className="w-full bg-black mt-4 text-white p-2 rounded-lg mb-6 hover:bg-cyan-400 hover:text-black hover:border hover:border-gray-300"
          onClick={register}
        >
          Sign Up
        </button>
        ...
        <div className="text-center text-gray-400">
          ...
          <Link
            href="/sign-in"
            className="font-bold text-black hover:text-cyan-300"
          >
            Sign In
          </Link>
        </div>
